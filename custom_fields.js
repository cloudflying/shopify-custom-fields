                    ...
                    var a = function() {
                        ...
                        return {
                            ...
                            save_custom_fields: function(b) {
                                if ("object" === typeof b)
                                    if ("undefined" === typeof b.url) a.notice("Error, metafield url not set", !0);
                                    else {
                            ...
                            setup_custom_fields: function(b) {
                                ...
                                g.length ? (a.setting("hideProductCustomFields") || g.after(custom_field_panel), d.length && "Save" === d.text() && d.text("Save (without Custom Fields)"),
                                    a.data("fields", []), $.ajax({
                                        type: "GET",
                                        url: "/admin/metafields.json?limit=250",
                                        dataType: "json",
                                        success: function(b) {
                                            for (var e, d, k = "", f = "", h = 0, g = b.metafields.length; h < g; h++) {
                                                ...
                                                if (m.limit === a.data("alpha") || !1 === m.limit)
                                                    if (n === a.data("namespace") || n === a.data("namespace_new") || d) {
                                            ...
                                            if (b) {
                                                ...
                                                if ("undefined" !== a.setting("datalists"))
                                                    for (e in k = a.setting("datalists"), k)
                                                        if (f = $('input[data-key="' + e + '"]'), f.length && "false" === f.attr("data-cftype")) {
                                                            b = $("<datalist />", {
                                                                id: "list-" + e
                                                            });
                                                            f.attr("list", "list-" + e);
                                                            var h = k[e];
                                                            for (u in h) h.hasOwnProperty(u) && (g = $("<option />", {
                                                                value: h[u]
                                                            }), b.append(g));
                                                            f.after(b)
                                                        } $.ajax({
                                    ...
                                    })) : a.notice("Custom Fields error : setup_custom_fields() : target html not found JP",
                                    !0);
                                "products" === b && (b = $("<button />", {
                                    "class": "btn btn-slim btn--icon next-field--connected next-field--connected--no-flexn"
                                }).html('<span class="tooltip-container"><span class="tooltip-label">Show Custom Fields</span></span><svg style="vertical-align: top" xmlns="http://www.w3.org/2000/svg" version="1.1" x="0px" y="0px" width="12px" height="12px" viewBox="0 0 12 12" enable-background="new 0 0 12 12" xml:space="preserve"><polygon fill="#D81965" points="0,0 0,12 10,12 10,11 11,11 11,10 12,10 12,0 "/><path fill="#FFFFFF" d="M7 9v1h1V9H7zM8 11h1v-1H8V11zM9 10h1V9H9V10zM10 9h1V8h-1V9zM1 11h1v-1H1V11zM2 10h1V9H2V10zM3 9h1V8H3V9zM1 6h10V5H1V6zM1 4h10V3H1V4zM1 1v1h10V1H1zM4 11v-1H3v1H4zM1 8v1h1V8H1z"/></svg>').on("click",
                                    function(b) {
                                        b.preventDefault();
                                        var c = $(this);
                                        ...
                                        var d = $("<tr />", {
                                            "class": "custom_fields_box is-variant"
                                        });
                                        if (a.data("variantRowsLength")) b = c.closest("tr");
                                        else {
                                        ...
                                        if (g) {
                                            var h = $("<a />", {
                                                    ...
                                                    b = {
                                                        t: $(this),
                                                        url: "/admin/variants/" + g + "/metafields.json",
                                                        type: "variant"
                                                    };
                                                    a.save_custom_fields(b)
                                                }),
                                            ...
                                            var k = !0,
                                                f = $("<td />", {
                                                    colspan: "100",
                                                    style: "padding:1.5vh 0;border-bottom:2px solid #000"
                                                });
                                            ...
                                            k ? (d.find('input[data-cftype="collection"]').each(function() {
                                                ...
                                                success: function(b) {
                                                    ...
                                                    if ("undefined" !== a.setting("datalists")) {
                                                        ...
                                                        for (var k in b)
                                                            if (d = c.find('input[data-key="' + k + '"]'), 1 === d.length) {
                                ...
                                $.ajax({
                                    ...
                                    success: function(b) {
                                        a.data("shop_metafields",
                                            b);
                                        for (var c = 0, d = b.metafields.length; c < d; c++)
                                            if ("custom_fields_config" === b.metafields[c].namespace)
                                                if ("whitelist" === b.metafields[c].key) {
